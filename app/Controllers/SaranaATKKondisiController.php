...
class SaranaATKKondisiController {
  private function renderView(string $view, $data = []) {
    extract($data);
    require_once __DIR__ . "/../Views/Pages/Kondisi/SaranaATK/{$view}.php";
  }
  ...
  public function update($id) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      // Untuk KondisiController, pertahankan data peminjaman yang ada
