...
class BarangBergerakController
{
    ...
    public function bergerak()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $id = $_POST['id'] ?? null;
            $kode_barang_bergerak = $_POST['kode_barang_bergerak'] ?? null;
            $nama_barang_bergerak = $_POST['nama_barang_bergerak'] ?? null;
            $barang_id = $_POST['barang_id'] ?? null;
            $kategori_id = $_POST['kategori_id'] ?? null; // Add this line
