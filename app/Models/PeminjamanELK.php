...
{
  /**
   * Stores a new loan record for a Sarana ATK item.
  ...
  /**
   * Retrieves all loan records from the peminjaman_atk table.
   *
   * @param PDO $conn The database connection.
  ...
  {
    try {
      $stmt = $conn->query("SELECT * FROM peminjaman_atk");
