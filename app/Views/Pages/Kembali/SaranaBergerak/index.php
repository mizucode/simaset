      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Apakah Anda yakin ingin menghapus data peminjaman sarana bergerak ini?
          </div>
          ...
          <div class="col-12">
            ...
            <div class="card shadow-md">
              <div class="card-header bg-navy text-white d-flex justify-content-between align-items-center">
                <h3 class="h4 mb-0">Data Pengembalian Sarana Bergerak</h3>
                <!-- Tombol Tambah Data Peminjaman dihapus sesuai referensi -->
              </div>
                        ...
                        <?php foreach ($saranaData as $sarana) : ?>
                          <tr>
                            ...
                            <td class="text-center">
                              ...
                              <?php if ($idSarana) : ?>
                                <a href="/admin/sarana/bergerak/kembali?edit=<?= htmlspecialchars($idSarana); ?>" class="btn btn-sm btn-success">
                                  <i class="fas fa-handshake mr-1"></i>Edit
                                </a>
                              <?php else : ?>
                                -
                              <?php endif; ?>
