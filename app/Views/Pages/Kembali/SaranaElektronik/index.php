          ...
          <div class="col-12">
            ...
            <div class="card shadow-md">
              <div class="card-header bg-navy text-white d-flex justify-content-between align-items-center">
                <h3 class="h4 mb-0">Data Pengembalian Sarana Elektronik</h3>
              </div>
                        ...
                        <?php foreach ($saranaData as $sarana) : ?>
                          <tr>
                            ...
                            <td class="text-center">
                              ...
                              <?php if ($idSarana) : ?>
                                <a href="/admin/sarana/elektronik/kembali?edit=<?= htmlspecialchars($idSarana); ?>" class="btn btn-sm btn-success"><i class="fas fa-handshake mr-1"></i>Edit</a>
                              <?php else : ?>
                                -
                              <?php endif; ?>
                            </td>
