        ...
        <div class="row justify-content-center ">
          <div class="col-12 ">
            ...
            <div class="card">
              ...
              <form action="/admin/sarana/elektronik/kembali?edit=<?= htmlspecialchars($sarana['id']) ?>" method="POST" enctype="multipart/form-data">
                <!-- Hidden Fields -->
                <input type="hidden" name="id" value="<?= htmlspecialchars($sarana['id'] ?? '') ?>">
                <input type="hidden" name="kategori_barang_id" value="3">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-12 mt-4 border-bottom">
                      ...
                      <div class=" py-4 px-4 mb-4 border rounded-md">
                        <div class="">
                          <label for="nama_peminjam" class="fw-normal ">Nama Pengembali <span class="text-danger">*</span></label>
                          <input type="text" class="form-control" id="nama_peminjam" name="nama_peminjam"
                            placeholder="Contoh: Muhammad Febrianoor" value="<?= htmlspecialchars($sarana['nama_peminjam']) ?>" required>
                          <span class="form-text">
                            Cek nama pengembali barang, jika pengembali berbeda dengan peminjam, silahkan isi nama pengembali.
                          </span>
                      ...
                      <div class=" py-4 px-4 mb-4 border rounded-md">
                        <div class="">
                          ...
                          <input type="text" class="form-control" id="identitas_peminjam" name="identitas_peminjam" value="<?= htmlspecialchars($sarana['identitas_peminjam']) ?>"
                            placeholder="Contoh: 211222047" required>
                          <span class="form-text">
                            Masukan nomor identitas pengembali berupa nik/nidn/nim.
                          </span>
                      ...
                      <div class=" py-4 px-4 mb-4 border rounded-md">
                        <div class="">
                          <label for="no_hp_peminjam" class="fw-normal ">Nomor HP Pengembali <span class="text-danger">*</span></label>
                          <input type="text" class="form-control" id="no_hp_peminjam" value="<?= htmlspecialchars($sarana['no_hp_peminjam']) ?>" name="no_hp_peminjam"
                    ...
                    <div class="col-12 mt-4 border-bottom">
                      ...
                      <div class=" py-4 px-4 mb-4 border rounded-md">
                        <div class="">
                          <label for="tanggal_peminjaman" class="fw-normal ">Tanggal Pengembalian <span class="text-danger">*</span></label>
                      ...
                      <div class=" py-4 px-4 mb-4 border rounded-md">
                        <div class="">
                          <label for="tanggal_pengembalian" class="fw-normal ">Cek Tanggal Rencana Pengembalian <span class="text-danger">*</span></label>
                          <input type="date" class="form-control" id="tanggal_pengembalian" name="tanggal_pengembalian"
                            value="<?= htmlspecialchars($sarana['tanggal_pengembalian'] ?? '') ?>" required>
                          <span class="form-text">
                            Cek apakah sesuai dengan tanggal rencana barang ini akan dikembalikan.
                          </span>
                    ...
                    <div class="col-12 mt-4 border-bottom">
                      ...
                      <div class="py-4 px-4 mb-4 border rounded-md">
                        ...
                        <span class="form-text">
                          Pilih lokasi barang akan diletakan kembali.
                        </span>
                      </div>
                      ...
                      <div class="py-4 px-4 mb-4 border rounded-md">
                        <div>
                          ...
                          <span class="form-text">
                            Pilih ke status tersedia atau terpakai jika barang tersebut sudah dikembalikan.
                          </span>
                        </div>
                      </div>
                  ...
                  <div class="card-footer text-right">
                    <a href="/admin/sarana/elektronik/kembali" class="btn btn-secondary">
                      <span><i class="fas fa-arrow-alt-circle-left mr-2"></i></span>Kembali
                    </a>
                    <button type="submit" class="btn btn-primary" id="submitBtn">
                      <i class="fas fa-save mr-2"></i>
                      Submit Data Pengembalian </button>
                  </div>
              </form>
            </div>
          </div>
