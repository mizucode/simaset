        ...
        <div class="row justify-content-center ">
          <div class="col-12 ">
            ...
            <div class="card">
              ...
              <form action="/admin/sarana/mebelair/kembali?edit=<?= htmlspecialchars($sarana['id']) ?>" method="POST" enctype="multipart/form-data">
                <!-- Hidden Fields -->
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-12 mt-4 border-bottom">
                      <!-- Data Identitas Sarana -->
                      <div class="border-bottom pb-2 mb-3">
                        <h5 class="text-bold fs-4 text-navy">LOKASI PENGEMBALIAN
                        </h5>
                  ...
                  <div class="card-footer text-right">
                    <a href="/admin/sarana/mebelair/kembali" class="btn btn-secondary">
