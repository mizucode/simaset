        ...
        <div class="row justify-content-center ">
          <div class="col-12 ">
            ...
            <div class="card">
              ...
              <form action="/admin/sarana/atk/pinjam?edit=<?= htmlspecialchars($sarana['id']) ?>" method="POST" enctype="multipart/form-data">
                <!-- Hidden Fields -->
                ...
                <div class="card-body">
                  ...
                  <div class="card-footer text-right">
                    <a href="/admin/sarana/atk/pinjam/tambah" class="btn btn-secondary">
