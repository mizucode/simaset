        ...
        <div class="row justify-content-center ">
          <div class="col-12 ">
            ...
            <div class="card">
              ...
              <form action="/admin/sarana/atk/kembali?edit=<?= htmlspecialchars($sarana['id']) ?>" method="POST" enctype="multipart/form-data">
                <!-- Hidden Fields -->
                ...
                <div class="card-footer text-right text-white">
                  <a href="/admin/sarana/atk/kembali" class="btn btn-secondary">
