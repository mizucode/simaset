...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="col-12 mb-5">
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="rounded-md d-flex align-items-stretch border bg-white select2-custom-wrapper">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text border-0 bg-light">
                                                                <i class="fas fa-chair text-primary"></i> <!-- Ikon disesuaikan untuk mebelair -->
                                                            </span>
                                                        </div>
                                                        <select class="form-control rounded border-0 select2-custom" id="barang_id" name="barang_id" required>
                                                            ...
                                                            <?php foreach ($barangList as $barang): ?>
                                                                <?php if ($barang['kategori_id'] == 2): // Filter untuk kategori mebelair 
                                                                ?>
                                                    ...
                                                    <small class="form-text text-muted mt-1">Pilih jenis barang mebelair dari daftar atau ketik untuk mencari</small>
                                                </div>
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="nama_detail_barang" name="nama_detail_barang"
                                                            placeholder="Contoh: Meja Rapat Kayu Jati, Kursi Direktur Ergonomis" required
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="merk" name="merk"
                                                            placeholder="Contoh: IKEA, Informa, Olympic, dll"
                                            ...
                                            <!-- Data Kondisi, Kuantitas, dan Tanggal -->
                                            <div class="col-12 mb-5">
                                                <h5 class="border-bottom pb-2 mb-3 text-bold">
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" class="form-control" id="biaya_pembelian" name="biaya_pembelian"
                                                            placeholder="Contoh: 1500000 (tanpa titik/koma)" min="0"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#barang_id').select2({ // ID diubah dari barang_input ke barang_id agar konsisten
                placeholder: "Pilih atau ketik jenis barang mebelair",
                allowClear: false, // Set true jika ingin ada tombol (x) untuk clear
                minimumResultsForSearch: 1,
            });



            // Kondisi Barang (jika ingin Select2)
