                            ...
                            <div class="card-header text-white">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h3 class="card-title text-lg">
                                        Detail Barang Meberlair (Meubel)
                                    </h3>
                                    <div class="text-right">
                                        ...
                                        <a href="/admin/sarana/mebelair?edit=<?= $detailData['id']; ?>" class="btn btn-warning btn-sm mr-2">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="info-box bg-light">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text">Merk/Tipe</span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="info-box bg-light">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number"><?= htmlspecialchars($detailData['bahan'] ?? '-') ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="bahan">Spesifikasi</label>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Apakah Anda yakin ingin menghapus perabotan ini? Tindakan ini tidak dapat dibatalkan.</p>
                    </div>
