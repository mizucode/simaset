...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  ...
  <script>
    $(function() { // Menggunakan $(function() shorthand untuk $(document).ready()
      $("#atkTable").DataTable({
        "responsive": true,
        "lengthChange": true,
        "autoWidth": false,
        ...
        "buttons": [{
            extend: 'copy',
            title: 'Data Barang ATK', // Judul disesuaikan
            exportOptions: {
              columns: [0, 1, 2, 3, 4] // Kolom: No, No Registrasi, Nama Barang, Jenis, Kondisi Saat Ini
            }
          },
          {
            extend: 'csv',
