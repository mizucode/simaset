                                        ...
                                        <div class="info-box bg-light">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <div class="text-center mt-2">
                                                    <!-- Preview kecil QR Code -->
                                                    <canvas id="qrPreview" width="100" height="100" class="mb-2"></canvas>
                                                    <br>
                                                    <button id="downloadQR" class="btn btn-sm btn-success">
                                                        <i class="fas fa-download mr-1"></i> Download QR Code
                                                    </button>
                                                    <!-- Canvas untuk QR Code resolusi tinggi yang disembunyikan -->
        ...
        $(document).ready(function() {
            ...
            $('#downloadQR').click(function() {
                if (noRegistrasi) {
                    ...
                    QRCode.toCanvas(canvas, noRegistrasi, {
                        width: 900, // Lebih besar untuk kualitas cetak
                        margin: 2,
                        color: {
                            dark: '#000000',
                            light: '#ffffff'
                        ...
                        link.download = 'QRCode-' + noRegistrasi + '.png';
                        link.href = canvas.toDataURL('image/png');
                        link.click();
                    });
                } else {
                    alert('Nomor registrasi tidak tersedia');
                }
            });
        });
    </script>
