                        ...
                        <div class="card card-navy">
                            <div class="card-header text-white">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <a href="/admin/sarana/elektronik?edit=<?= $detailData['id']; ?>" class="btn btn-warning btn-sm mr-2">
                            ...
                            <div class="card-body">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="info-box bg-light">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text">Merk/Model</span>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="info-box bg-light">
                                            <span class="info-box-icon bg-orange"><i class="fas fa-microchip"></i></span>
                                            <div class="info-box-content">
                                                <span class="info-box-text">Tipe</span>
                                                <span class="info-box-number"><?= htmlspecialchars($detailData['tipe'] ?? '-') ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="info-box bg-light">
                                            <span class="info-box-icon bg-<?= ($detailData['nama_kondisi'] ?? 'Baik') === 'Baik' ? 'green' : ($detailData['nama_kondisi'] === 'Rusak Ringan' ? 'warning' : ($detailData['nama_kondisi'] === 'Rusak Berat' ? 'danger' : ($detailData['nama_kondisi'] === 'Hilang' ? 'dark' : 'info'))) ?>">
                                                <i class="fas fa-clipboard-check"></i>
                                            </span>
                                            <div class="info-box-content">
                                                <span class="info-box-text">nama_kondisi</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-plaintext border rounded p-2 bg-light">
                                        <?= htmlspecialchars($detailData['nama_barang'] ?? '') ?>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-plaintext border rounded p-2 bg-light">
                                                <?= htmlspecialchars($detailData['tipe'] ?? '') ?>
                                            </div>
                                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Apakah Anda yakin ingin menghapus barang elektronik ini? Tindakan ini tidak dapat dibatalkan.</p>
                    </div>
