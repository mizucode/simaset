                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="merk" name="merk"
                                                            placeholder="Contoh: ASUS, Dell, Lenovo, dll">
                                                    </div>
                                                </div>
                                                <!-- Tipe -->
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="tipe" name="tipe"
                                                            placeholder="Contoh: ROG Strix G15, ThinkPad X1 Carbon, dll">
                                                    </div>
                                                </div>
                                                <!-- Spesifikasi -->
                                                <div class="form-group mb-4">
                                                    ...
                                                    <textarea class="form-control" id="spesifikasi" name="spesifikasi" rows="3"
                                                        placeholder="Masukkan spesifikasi teknis (processor, RAM, storage, OS, dll)"></textarea>
                                                </div>
                                            </div>
