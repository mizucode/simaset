  ...
  <body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed px-3">
              ...
              <div class="card">
                ...
                <form action="/admin/sarana/elektronik/tambah" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="col-12">
                        ...
                        <div class="col-12 mt-4 border-bottom">
                          <div class="border-bottom pb-2 mb-3">
                            ...
                            <span class="form-text">Isi informasi kondisi, kuantitas, dan detail pembelian sarana elektronik.</span>
                          </div>
                  ...
                  <div class="card-footer text-right text-white">
                    <a href="/admin/sarana/elektronik" class="btn btn-secondary text-white">
    ...
    <script>
      $(document).ready(function() {
        // Inisialisasi Select2 untuk Jenis Barang Elektronik dan Lokasi
