          ...
          <div class="col-12">
            ...
            <div class="card shadow-md">
              <div class="card-header bg-navy text-white d-flex justify-content-between align-items-center">
                <h3 class="h4 mb-0">Data Sarana Mebelair Siap Pindah</h3>
                  ...
                  <table id="saranaTable" class="table table-bordered w-100">
                    <thead class="bg-gray-100">
                      <tr class="text-center">
                        ...
                        <th width="20%">Lokasi Penempatan</th>
                        <th width="15%">Aksi</th>
                      </tr>
                    </thead>
                    <tbody>
                        ...
                        <?php foreach ($saranaData as $sarana) : ?>
                          <tr>
                            ...
                            <td class="text-center">
                              <a href="/admin/sarana/mebelair/pindah?edit=<?= $sarana['id']; ?>" class="btn btn-sm btn-warning" title="Edit">
  ...
  <script>
    $(document).ready(function() {
      $("#saranaTable").DataTable({
        ...
        "buttons": [{
            extend: 'copy',
            title: 'Data Sarana Mebelair Siap Pindah',
            exportOptions: {
              columns: [0, 1, 2, 3, 4] // No, No Registrasi, Nama Barang, Jenis, Lokasi Penempatan
            }
          },
          {
            extend: 'csv',
