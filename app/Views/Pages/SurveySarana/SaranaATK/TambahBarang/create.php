        ...
        <div class="row justify-content-center ">
          <div class="col-12 ">
            ...
            <div class="card bg-">
              ...
              <form action="/admin/survey/sarana/sarana-atk?tambah-barang=<?= htmlspecialchars($surveyData['id']) ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-12 border-bottom">
                      ...
                      <div class="py-4 px-4 mb-4 border rounded-md">
                        ...
                        <div class="form-group">
                          ...
                          <span class="form-text">Pilih barang Atk.</span>
                        </div>
                      </div>
