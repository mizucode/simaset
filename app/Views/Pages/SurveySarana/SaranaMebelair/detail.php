            ...
            <div class="card card-navy">
              <div class="card-header text-white">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="text-right">
                    <a href="/admin/survey/sarana/sarana-mebelair?delete=<?= htmlspecialchars($surveyData['id'] ?? '-') ?>" class="btn btn-danger btn-sm mr-1">
                      <i class="fas fa-trash mr-1"></i> Hapus
                    </a>
                    <a href="/admin/survey/sarana/sarana-mebelair?edit=<?= htmlspecialchars($surveyData['id'] ?? '-') ?>" class="btn btn-warning btn-sm mr-1">
                      <i class="fas fa-edit mr-1"></i> Edit
                    </a>
                    <a href="/admin/survey/sarana/sarana-mebelair" class="btn btn-secondary btn-sm ">
              ...
              <div class="card-body">
                ...
                <div class="border-bottom pb-2 mb-3 flex justify-content-between">
                  ...
                  <a href="/admin/survey/sarana/sarana-mebelair?tambah-barang=<?= htmlspecialchars($surveyData['id'] ?? '') ?>" class="btn btn-warning btn-sm ml-auto">
                    <div class="text-dark">
                      ...
                      <?php foreach ($dataSurvey as $index => $item) : ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="/admin/survey/sarana/sarana-mebelair?delete-barang=<?= htmlspecialchars($item['id']) ?>"
