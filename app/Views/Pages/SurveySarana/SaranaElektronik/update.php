        ...
        <div class="row justify-content-center ">
          <div class="col-12 ">
            ...
            <div class="card bg-">
              ...
              <form action="/admin/survey/sarana/sarana-elektronik?edit=<?= htmlspecialchars($survey['id']) ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="card-footer text-right">
                    <a href="/admin/survey/sarana/sarana-elektronik" class="btn btn-secondary">
