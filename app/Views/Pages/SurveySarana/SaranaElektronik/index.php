          ...
          <div class="col-12">
            ...
            <div class="card shadow-md">
              <div class="card-header bg-navy text-white d-flex justify-content-between align-items-center">
                <h3 class="h4 mb-0">Data Survey Sarana Elektronik</h3>
                <a href="/admin/survey/sarana/sarana-elektronik/tambah" class="btn btn-warning btn-sm ml-auto">
                  <div class="text-dark">
                          ...
                          <tr class="align-middle">
                            ...
                            <td class="text-center">
                              <div class="d-flex justify-content-center gap-2">
                                <a href="/admin/survey/sarana/sarana-elektronik?detail=<?= $data['id']; ?>" class="btn btn-info btn-sm">
  ...
  <script>
    $(function() {
      $("#surveySaranaTable").DataTable({
        ...
        "buttons": [{
            extend: 'copy',
            title: 'Data Survey Sarana Elektronik',
            exportOptions: {
