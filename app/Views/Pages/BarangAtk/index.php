            ...
            <div class="card shadow-md">
              <div class="card-header bg-navy text-white d-flex justify-content-between align-items-center">
                ...
                <div class="ml-auto d-flex flex-column flex-sm-row align-items-sm-center">
                  <a href="/admin/sarana/atk/download-qr" class="btn btn-success btn-sm mb-2 mb-sm-0 mr-sm-2">
                  ...
                  <a href="/admin/sarana/atk/tambah" class="btn btn-warning btn-sm mb-2 mb-sm-0">
              ...
              <div class="card-body p-3">
                <div class="table-responsive">
                  <table id="atkTable" class="table table-bordered w-100">
                          ...
                          <tr class="align-middle">
                            ...
                            <td class="text-center">
                              <div class="d-flex justify-content-center gap-2">
                                <a href="/admin/sarana/atk/detail/<?= $barang['no_registrasi']; ?>" class="btn btn-info btn-sm">
  ...
  <script>
    $(function() {
      ...
      $('#jenisFilter').on('change', function() {
        var val = $(this).val();
        // Escape karakter khusus dan handle spasi/slash
        var escapedVal = val ? $.fn.dataTable.util.escapeRegex(val.trim()) : '';
        // Gunakan pencarian exact match dengan regex
      ...
      $('#statusFilter').on('change', function() {
        ...
        table.column(5) // Index kolom 'Status'
          .search(val ? '^' + $.fn.dataTable.util.escapeRegex(val) + '$' : '', true, false) // Konsistensi: escape juga status
          .draw();
      });
      ...
      $('#downloadSelectedQR').on('click', function() {
        ...
        form.attr('action', '/admin/sarana/atk/download-qr');
