                    ...
                    <div class="col-12 ">
                        ...
                        <div class="card card-navy">
                            ...
                            <form action="/admin/sarana/atk/tambah" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="kategori_barang_id" value="3" id="kategori_barang_id"> <!-- Sesuaikan ID kategori ATK -->
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control" id="barang_id" name="barang_id" required>
                                                            ...
                                                            <?php foreach ($barangList as $barang): ?>
                                                                <?php if ($barang['kategori_id'] == 3): ?> <!-- Sesuaikan ID kategori ATK -->
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="nama_detail_barang" name="nama_detail_barang"
                                                            placeholder="Contoh: Pensil 2B" required>
                                                    </div>
                                                </div>
                                                <!-- No Registrasi -->
                                                <div class="form-group mb-4">
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="merk" name="merk"
                                                            placeholder="Contoh: Faber-Castell, Stabilo, dll">
                                                    </div>
                                                </div>
                                                <!-- Spesifikasi -->
                                                <div class="form-group mb-4">
                                                    ...
                                                    <textarea class="form-control" id="spesifikasi" name="spesifikasi" rows="3"
                                                        placeholder="Masukkan spesifikasi lengkap (warna, ukuran, dll)"></textarea>
                                                </div>
                                            </div>
