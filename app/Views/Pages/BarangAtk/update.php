                            ...
                            <form action="<?= isset($sarana) ? '/admin/sarana/atk?edit=' . $sarana['id'] : '/admin/sarana/atk/tambah' ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                                            ...
                                                            <?php foreach ($barangList as $barang): ?>
                                                                <?php if ($barang['kategori_id'] == 3): ?>
                                                                    <option value="<?= htmlspecialchars($barang['id']) ?>"
                                                                        <?= (isset($sarana) && $sarana['barang_id'] == $barang['id']) ? 'selected' : '' ?>>
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="nama_detail_barang" name="nama_detail_barang"
                                                            placeholder="Contoh: Pensil 2B Faber Castell" required value="<?= isset($sarana) ? htmlspecialchars($sarana['nama_detail_barang']) : ''; ?>">
                                                    </div>
                                                </div>
                                                <!-- No Registrasi -->
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="no_registrasi" name="no_registrasi"
                                                            placeholder="Contoh: REG-ATK-001" required value="<?= isset($sarana) ? htmlspecialchars($sarana['no_registrasi']) : ''; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="merk" name="merk"
                                                            placeholder="Contoh: Faber Castell, Sinar Dunia, dll" value="<?= isset($sarana) ? htmlspecialchars($sarana['merk']) : ''; ?>">
                                                    </div>
                                                </div>
                                                <!-- Spesifikasi -->
                                                <div class="form-group mb-4">
                                                    ...
                                                    <textarea class="form-control" id="spesifikasi" name="spesifikasi" rows="3"
                                                        placeholder="Masukkan spesifikasi lengkap (ukuran, warna, tipe, dll)"><?= isset($sarana) ? htmlspecialchars($sarana['spesifikasi']) : ''; ?></textarea>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            <select class="form-control" id="satuan" name="satuan">
                                                                ...
                                                                <option value="Pack" <?= (isset($sarana) && $sarana['satuan'] == 'Pack') ? 'selected' : '' ?>>Pack</option>
                                                                <option value="Rim" <?= (isset($sarana) && $sarana['satuan'] == 'Rim') ? 'selected' : '' ?>>Rim</option>
                                                                <option value="Lusin" <?= (isset($sarana) && $sarana['satuan'] == 'Lusin') ? 'selected' : '' ?>>Lusin</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-footer text-right text-white">
                                        <a href="/admin/sarana/atk?detail=<?= isset($sarana) ? htmlspecialchars($sarana['id']) : ''; ?>" class="btn btn-secondary">
                                            <span><i class="fas fa-arrow-alt-circle-left mr-2"></i></span>Kembali
                                        </a>
                                        <button type="submit" class="btn btn-primary" id="submitBtn">
                                            <i class="fas fa-save mr-2"></i>
                                            Simpan Data Sarana ATK
                                        </button>
                                    </div>
                            </form>
                        </div>
