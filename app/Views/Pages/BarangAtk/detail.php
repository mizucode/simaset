...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
            ...
            <div class="card card-navy">
              <div class="card-header text-white">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="text-right">
                    ...
                    <a href="/admin/sarana/atk/edit/<?= htmlspecialchars($detailData['no_registrasi']); ?>" class="btn btn-warning btn-sm mr-2">
              ...
              <div class="card-body">
                ...
                <div class="border-bottom pb-2 mt-5 mb-3 d-flex justify-content-between align-items-center">
                  ...
                  <a href="/admin/sarana/atk?tambah-dokumen=<?= htmlspecialchars($detailData['id'] ?? '') ?>" class="btn btn-warning btn-sm">
                    <div class="text-dark">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php if (!empty($dokumenSaranaATK)) : ?>
                        <?php $no = 1; ?>
                        <?php foreach ($dokumenSaranaATK as $barang) : ?>
                          <tr>
                            <td class="text-center"><?= $no++ ?></td>
                            <td><?= htmlspecialchars($barang['nama_dokumen'] ?? '-') ?></td>
                            <td class="text-center">
                              <a href="/admin/sarana/atk?preview-file-dokumen=<?= htmlspecialchars($barang['id'] ?? '') ?>" class="btn btn-sm btn-info" title="Preview" target="_blank">
                                <i class="fas fa-eye"></i> Preview
                              </a>
                              <a href="/admin/sarana/atk?download-dokumen=<?= htmlspecialchars($barang['id'] ?? '') ?>" class="btn btn-sm btn-success" title="Download">
                ...
                <div class="border-bottom pb-2 my-5 d-flex justify-content-between align-items-center">
                  ...
                  <a href="/admin/sarana/atk?tambah-gambar=<?= htmlspecialchars($detailData['id'] ?? '') ?>" class="btn btn-warning btn-sm">
                    <div class="text-dark">
                      <i class="fas fa-plus mr-1"></i> Tambah Data
                    </div>
                  </a>
                        ...
                        <div class="card h-100 shadow-sm">
                          ...
                          <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto text-center">
                              <a href="/admin/sarana/atk?preview-gambar=<?= $idGambar ?>" class="btn btn-sm btn-primary" title="Lihat" target="_blank">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="/admin/sarana/atk?delete=<?= htmlspecialchars($detailData['id'] ?? '') ?>" id="confirmDeleteButton" class="btn btn-danger">Hapus</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <script>
    function confirmDeleteDokumen(dokumenId, saranaId, namaDokumen) {
      ...
      var deleteUrl = `/admin/sarana/atk?delete-dokumen=${dokumenId}&sarana_id=${saranaId}`;
    ...
    function confirmDeleteGambar(gambarId, saranaId, namaGambar) {
      ...
      var deleteUrl = `/admin/sarana/atk?delete-gambar=${gambarId}&sarana_id=${saranaId}`;
    ...
    $(document).ready(function() {
      ...
      $('#deleteModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '/admin/sarana/atk?delete=' + itemId;
      ...
      if (qrContainer) {
        ...
        if (nomorRegFromDataAttr && nomorRegFromDataAttr !== 'REG-TIDAK-ADA') {
          ...
          const qrPath = `/admin/sarana/atk/detail/${nomorRegFromDataAttr}`;
      ...
      if (qrPinjamContainer) {
        ...
        if (itemIdForPinjam) {
          const qrBaseUrl = "<?= $BaseUrlQr; ?>";
          const qrPinjamPath = `/admin/sarana/atk/pinjam?edit=${itemIdForPinjam}`;
