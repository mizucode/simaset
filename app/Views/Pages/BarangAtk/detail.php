              ...
              <div class="card-header text-white">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="text-right">
                    ...
                    <a href="/admin/sarana/atk?edit=<?= htmlspecialchars($detailData['id'] ?? ''); ?>" class="btn btn-warning btn-sm mr-2">
                        ...
                        <?php foreach ($dokumenSaranaATK as $barang): ?>
                          <tr>
                            ...
                            <td class="text-center">
                              <a href="/admin/sarana/atk?download-dokumen=<?= htmlspecialchars($barang['id'] ?? '') ?>"
                          ...
                          <div class="card-img-top position-relative" style="height: 200px; overflow: hidden;">
                            ...
                            <?php if ($pathGambar && in_array($extension, $allowedExtensions)): ?>
                              <a href="/admin/sarana/atk?preview-gambar=<?= $idGambar ?>" data-toggle="lightbox" data-title="<?= $namaDokumenGambar ?>" data-gallery="gallery-images">
                                <img src="/admin/sarana/atk?preview-gambar=<?= $idGambar ?>"
  ...
  <script>
    ...
    function confirmDeleteDokumen(dokumenId, saranaId) {
      if (confirm(`Apakah Anda yakin ingin menghapus dokumen ini? Tindakan ini tidak dapat dibatalkan.`)) {
        window.location.href = `/admin/sarana/atk?delete-dokumen=${dokumenId}&sarana_id=${saranaId}`;
      }
    }
    ...
    function confirmDeleteGambar(gambarId, saranaId) {
      if (confirm(`Apakah Anda yakin ingin menghapus gambar ini? Tindakan ini tidak dapat dibatalkan.`)) {
        window.location.href = `/admin/sarana/atk?delete-gambar=${gambarId}&sarana_id=${saranaId}`;
      }
    }
    ...
    $(document).ready(function() {
      ...
      $('#deleteModal').on('show.bs.modal', function(event) {
        ...
        var itemName = "<?= htmlspecialchars($detailData['nama_detail_barang'] ?? 'Barang Ini') ?>"; // Ambil 
      ...
      if (qrContainer) {
        ...
        if (itemId) {
          ...
          const qrPath = `/admin/sarana/atk?edit=${itemId}`;
