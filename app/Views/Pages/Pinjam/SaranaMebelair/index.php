          ...
          <div class="col-12">
            ...
            <div class="card shadow-md">
              <div class="card-header bg-navy text-white d-flex justify-content-between align-items-center">
                <h3 class="h4 mb-0">Data Peminjaman Sarana Mebelair</h3>
                <div class="ml-auto">
                  ...
                  <a href="/admin/sarana/mebelair/pinjam/tambah" class="btn btn-warning btn-sm text-dark">
              ...
              <div class="card-body p-3">
                ...
                <div class="table-responsive" style="overflow-x: auto;">
                  <table id="saranaTable" class="table table-bordered table-hover" style="width: 100%; min-width: 1000px;">
    ...
    $(document).ready(function() {
      ...
      $.fn.dataTable.ext.search.push(
        function(settings, data, dataIndex) {
          ...
          if (lokasiValue && data[8] !== lokasiValue) {
            return false;
          }
          // Filter tanggal peminjaman
          var min = $('#filterTanggalMin').val();
          var max = $('#filterTanggalMax').val();
          var cellDatePinjam = data[6]; // Kolom Tanggal Peminjaman
          ...
          var cellDateKembali = data[7]; // Kolom Tanggal Pengembalian
