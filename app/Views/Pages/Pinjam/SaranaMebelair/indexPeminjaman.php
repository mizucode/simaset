          ...
          <div class="col-12">
            ...
            <div class="card shadow-md">
              <div class="card-header bg-navy text-white d-flex justify-content-between align-items-center">
                <h3 class="h4 mb-0">Daftar Sarana Mebelair Tersedia untuk Dipinjam</h3>
              </div>
                        ...
                        <?php foreach ($saranaData as $sarana) : ?>
                          <tr>
                            ...
                            <td class="text-center">
                              <?php $idSarana = $sarana['id'] ?? null; // Menggunakan id standar untuk Mebelair 
                              ?>
                              <?php if ($idSarana) : ?>
                                <a href="/admin/sarana/mebelair/pinjam?edit=<?= htmlspecialchars($idSarana); ?>" class="btn btn-sm btn-success"><i class="fas fa-handshake mr-1"></i>Pinjam</a>
                              <?php else : ?>
                                -
                              <?php endif; ?>
                            </td>
  ...
  <script>
    $(function() {
      $("#saranaTable").DataTable({
        ...
        "buttons": [{
            extend: 'copy',
            title: 'Daftar Sarana Mebelair Tersedia',
            exportOptions: {
