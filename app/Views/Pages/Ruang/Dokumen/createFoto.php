...
<!-- Apply px-3 to match Tanah/Dokumen/createFoto.php -->
...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed px-3">
  ...
  <div class="wrapper">
    ...
    <!-- Adjust padding to match Tanah/Dokumen/createFoto.php -->
            ...
            <div class="card bg-">
              ...
              <form action="/admin/prasarana/ruang?tambah-gambar=<?= $ruangData['id'] ?? '' ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-12 border-bottom">
                      <div class="border-bottom pb-2 mb-3">
                        <h5 class="text-bold fs-4 text-navy">
                          DATA DOKUMENTASI RUANG
                        </h5>
                        <span class="form-text">Silahkan isi data dokumentasi ruang dengan lengkap.</span>
                      </div>

                      <!-- Aset Ruang - Hidden field for ID, consistent with Tanah -->
                      <div class="py-4 px-4 mb-4 border rounded-md hidden">
                        <div class="form-group">
                          <label for="aset_ruang_id_display" class="fw-bold">Pilih Aset Ruang</label>
                          <input type="text" class="form-control" id="aset_ruang_id_display"
                            value="<?= htmlspecialchars($ruangData['nama_ruang'] ?? $ruangData['id']) ?>" readonly>
                          <input type="hidden" name="aset_ruang_id" value="<?= htmlspecialchars($ruangData['id']) ?>">
                        </div>
                      </div>
                      ...
                      <div class="py-4 px-4 mb-4 border rounded-md">
                        <div class="form-group">
                          ...
                          <input type="text" placeholder="Contoh: Foto Ruang Bagian Depan" class="form-control" id="nama_dokumen" name="nama_dokumen" value="" required>
                      ...
                      <div class="py-4 px-4 mb-4 border rounded-md">
                        <div class="form-group">
                          <label for="path_dokumen" class="fw-bold">Upload Dokumentasi / Foto Ruang <span class="text-danger">*</span></label>
                ...
                <div class="card-footer text-right">
                  <a href="/admin/prasarana/ruang?detail=<?= htmlspecialchars($ruangData['id'] ?? '') ?>" class="btn btn-secondary">
                    <span><i class="fas fa-arrow-alt-circle-left mr-2"></i></span>Kembali
                  </a>
                  <button type="submit" class="btn btn-primary" id="submitBtn">
                    <i class="fas fa-save mr-2"></i>
                    Simpan Dokumentasi Ruang
                  </button>
                </div>
              </form>
            </div>
