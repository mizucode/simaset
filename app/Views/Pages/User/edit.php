                    ...
                    <div class="col-12">
                      <div class="col-12 border-bottom">
                        <div class="border-bottom pb-2 mb-3">
                          ...
                          <span class="form-text">Silakan perbarui data user dengan lengkap.</span>
                        </div>
                        <div class="py-4 px-4 mb-4 border rounded-md">
                          <div class="form-group">
                            <label for="username" class="fw-bold">Username <span class="text-danger">*</span></label>
                            <input type="text" name="username" id="username" class="form-control" placeholder="Masukkan username" value="<?= htmlspecialchars($user['username']) ?>" required>
                        ...
                        <div class="py-4 px-4 mb-4 border rounded-md">
                          <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" class="form-control" placeholder="Masukkan email aktif" value="<?= htmlspecialchars($user['email']) ?>" required>
                        ...
                        <div class="py-4 px-4 mb-4 border rounded-md">
                          <div class="form-group">
                            ...
                            <input type="password" name="password" id="password" class="form-control" placeholder="Masukkan password baru (kosongkan jika tidak ingin mengubah)">
                            <span class="form-text">Kosongkan jika tidak ingin mengubah password. Gunakan password yang kuat dan mudah diingat.</span>
